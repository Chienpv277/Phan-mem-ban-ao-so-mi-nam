...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        listMenu1.addItem(new Model_Menu("home", "Thống kê", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("hoadon", "Hóa đơn", Model_Menu.MenuType.MENU));
...
//        listMenu1.addItem(new Model_Menu("camera2", "QR", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("hoadon", "Bán hàng", Model_Menu.MenuType.MENU));
...
//        listMenu1.addItem(new Model_Menu("", "", Model_Menu.MenuType.EMPTY));
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/logo02.png"))); // NOI18N
